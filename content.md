...
При написании комбинаторов мы не использовали специфику синтаксического разбора, поэтому можно предположить, что подобный подход можно использовать и других случаях.
